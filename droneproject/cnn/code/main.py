...
train_data_augmented = ImageDataset(
    targ_dir=train_dir, transform=train_transforms)
...
train_dataloader = DataLoader(
    train_data_augmented, batch_size=batch_size, shuffle=False, sampler=train_sampler)
validation_dataloader = DataLoader(
    train_data, batch_size=batch_size, shuffle=False, sampler=validation_sampler)
